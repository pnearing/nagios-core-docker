                    ...
                    <table border="0" cellpadding="0" class="content_formtable">
                        ...
                        <tr>
                            ...
                            <td class="content_tbl_row3"><img src="{IMAGE_PATH}tip.gif" alt="{LANG_HELP}"
                                                              ...
                                                              onclick="dialoginit('servicetemplate','template_name','all','Info');"
                                        ...
                                        <td>
                                            <select title="{LANG_HOSTS}" name="mselValue1[]" size="4" multiple
                                                ...
                                                <option value="{DAT_HOSTS_ID}"
                                                        class="empty_class {SPECIAL_STYLE} {IE_HOSTS_SEL}" {DAT_HOSTS_SEL} {OPTION_DISABLED}>{DAT_HOSTS}</option>
                                                <!-- END hosts -->
                                            </select>
                                        </td>
                                    </tr>
                                ...
                                <table cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                        ...
                                        <td class="radio_cell_1"><input title="{LANG_STANDARD}" name="radValue1"
                                                                        ...
                                                                        value="2" {DAT_HOS2_CHECKED} tabindex="2"></td>
                                        <td class="radio_cell_2">{LANG_STANDARD}</td>
                                    </tr>
                                </table>
                            </td>
                            <td colspan="2"><img src="{IMAGE_PATH}tip.gif" alt="{LANG_HELP}" title="{LANG_HELP}"
                                                 width="18" height="18"
                        ...
                        <tr>
                            <td valign="top"><span
                                        class="{VERSION_40_VISIBLE}">{LANG_PARENT_SERVICES}<br><br><small>{LANG_CTRLINFO}</small></span>
                            </td>
                            <td valign="top">
                            ...
                            <td valign="top"><span class="{VERSION_40_VISIBLE}"><img id="mutvalue6"
                        ...
                        <tr>
                            ...
                            <td><input title="{LANG_SERVICE_DESCRIPTION}" name="tfValue2" type="text" id="tfValue2"
                                       value="{DAT_SERVICE_DESCRIPTION}" tabindex="4"></td>
                            <td><img src="{IMAGE_PATH}tip.gif" alt="{LANG_HELP}" title="{LANG_HELP}" width="18"
                                     height="18" onclick="dialoginit('service','service_description','all','Info');"
                                     class="infobutton_1"></td>
                            <td>{LANG_DISPLAY_NAME}</td>
                            <td><input title="{LANG_DISPLAY_NAME}" name="tfValue3" type="text" id="tfValue3"
                        ...
                        <tr>
                            ...
                            <td>
                                <select title="{LANG_CHECK_COMMAND}" name="selValue1" id="selValue1"
                                        class="selectborder" onChange="setIframe(this.value);" tabindex="8">
                                    <!-- BEGIN servicecommand -->
                                    <option value="{DAT_SERVICECOMMAND_ID}"
                                            class="empty_class {SPECIAL_STYLE}" {DAT_SERVICECOMMAND_SEL}>{DAT_SERVICECOMMAND}</option>
                                    <!-- END servicecommand -->
                                </select>
                            </td>
                        ...
                        <tr>
                            <td colspan="6" style="padding-bottom:10px;">
                                <iframe id="templframe" frameborder="0"
                                        src="{BASE_PATH}admin/templatedefinitions.php?dataId={DAT_ID}&amp;type=servicetemplate"
                        ...
                        <tr>
                            ...
                            <td colspan="3"><input type="button" name="butTemplDefinition" value="{LANG_INSERT}"
                                                   onClick="insertDefintion()" tabindex="18"></td>
                        </tr>
                        <tr>
                            <td colspan="6">&nbsp;</td>
                        </tr>
                        <tr>
                            <td colspan="3"><input name="subForm" type="button" id="subForm1" value="{LANG_SAVE}"
                                                   onClick="LockButton();" {DISABLE_SAVE} tabindex="19">&nbsp;<input
                                        name="subAbort" type="button" id="subAbort1" onClick="abort();"
                                        value="{LANG_ABORT}" tabindex="20"><span
                ...
                <div id="tab2">
                    <table border="0" cellpadding="0" class="content_formtable">
                        ...
                        <tr class="{VERSION_20_VISIBLE}">
                            ...
                            <td colspan="4"><img src="{IMAGE_PATH}tip.gif" alt="{LANG_HELP}" title="{LANG_HELP}"
                                                 width="18" height="18"
                                                 onclick="dialoginit('service','parallelize_checks','2','Info');"
                                                 class="infobutton_1"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                        <td class="radio_cell_1"><input title="{LANG_ON}" name="radValue15" type="radio"
                                                                        class="checkbox" id="radValue151"
                                                                        value="1" {DAT_PED1_CHECKED}></td>
                                        <td class="radio_cell_2">{LANG_ON}</td>
                                        <td class="radio_cell_1"><input title="{LANG_OFF}" name="radValue15"
                                                                        type="radio" class="checkbox" id="radValue150"
                                                                        value="0" {DAT_PED0_CHECKED}></td>
                                        <td class="radio_cell_2">{LANG_OFF}</td>
                                        <td class="radio_cell_1"><input title="{LANG_SKIP}" name="radValue15"
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                        <td class="radio_cell_1"><input title="{LANG_ON}" name="radValue16" type="radio"
                                                                        class="checkbox" id="radValue161"
                                                                        value="1" {DAT_ISV1_CHECKED}></td>
                                        <td class="radio_cell_2">{LANG_ON}</td>
                                        <td class="radio_cell_1"><input title="{LANG_OFF}" name="radValue16"
                                                                        type="radio" class="checkbox" id="radValue160"
                                                                        value="0" {DAT_ISV0_CHECKED}></td>
                                        <td class="radio_cell_2">{LANG_OFF}</td>
                                        <td class="radio_cell_1"><input title="{LANG_SKIP}" name="radValue16"
                    ...
                    <table border="0" cellpadding="0" class="content_formtable">
                                    ...
                                    <tr>
                                        <td>
                                            <select title="{LANG_CONTACT_GROUPS}" name="mselValue5[]" size="4" multiple
                                                    id="mselValue5" class="selectborder" {MSIE_DISABLED}>
                                                <!-- BEGIN service_contactgroups -->
                                                <option value="{DAT_SERVICE_CONTACTGROUPS_ID}"
                                                        class="empty_class {SPECIAL_STYLE} {IE_SERVICE_CONTACTGROUPS_SEL}" {DAT_SERVICE_CONTACTGROUPS_SEL} {OPTION_DISABLED}>{DAT_SERVICE_CONTACTGROUPS}</option>
                                        ...
                                        <td>
                                            <select title="{LANG_CONTACTS}" name="mselValue4[]" size="4" multiple
                                                ...
                                                <option value="{DAT_SERVICE_CONTACTS_ID}"
                                                        class="empty_class {SPECIAL_STYLE} {IE_SERVICE_CONTACTS_SEL}" {DAT_SERVICE_CONTACTS_SEL} {OPTION_DISABLED}>{DAT_SERVICE_CONTACTS}</option>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                        ...
                                        <td class="radio_cell_2">+</td>
                                        <td class="radio_cell_1"><input title="null" name="radValue5" type="radio"
                        ...
                        <tr>
                            ...
                            <td><input title="{LANG_NOTIFICATION_INTERVAL}" name="tfNullVal7" type="text"
                                       id="tfNullVal7" value="{DAT_NOTIFICATION_INTERVAL}"></td>
                            <td><img src="{IMAGE_PATH}tip.gif" alt="{LANG_HELP}" title="{LANG_HELP}" width="18"
                            ...
                            <td><input title="{LANG_FIRST_NOTIFICATION_DELAY}" name="tfNullVal8" type="text"
                                       id="tfNullVal8" value="{DAT_FIRST_NOTIFICATION_DELAY}"></td>
                            <td><img src="{IMAGE_PATH}tip.gif" alt="{LANG_HELP}" title="{LANG_HELP}" width="18"
                                     height="18"
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                        ...
                                        <td class="radio_cell_1">o</td>
                                        <td class="radio_cell_1"><input title="w" name="chbGr4b" type="checkbox"
                ...
                <div id="tab4">
                    <table border="0" cellpadding="0" class="content_formtable">
                        ...
                        <tr class="{VERSION_30_VISIBLE}">
                            ...
                            <td class="content_tbl_row2"><input title="{LANG_NOTES}" name="tfValue4" type="text"
                                                                id="tfValue4" value="{DAT_NOTES}" tabindex="1"></td>
                            <td class="content_tbl_row3"><img src="{IMAGE_PATH}tip.gif" alt="{LANG_HELP}"
                                                              title="{LANG_HELP}" width="18" height="18"
                                                              onclick="dialoginit('service','notes','3','Info');"
                                                              class="infobutton_1"></td>
                            <td class="content_tbl_row1">{LANG_ICON_IMAGE}</td>
                            <td class="content_tbl_row2"><input title="{LANG_ICON_IMAGE}" name="tfValue7" type="text"
                                                                id="tfValue7" value="{DAT_ICON_IMAGE}" tabindex="4">
                            </td>
                            <td class="content_tbl_row4"><img src="{IMAGE_PATH}tip.gif" alt="{LANG_HELP}"
                                                              title="{LANG_HELP}" width="18" height="18"
                                                              onclick="dialoginit('service','icon_image','3','Info');"
                                                              class="infobutton_1"></td>
                        </tr>
                        <tr class="{VERSION_30_VISIBLE}">
                            ...
                            <td><input title="{LANG_ICON_IMAGE_ALT_TEXT}" name="tfValue8" type="text" id="tfValue8"
                        ...
                        <tr class="{VERSION_30_VISIBLE}">
                            ...
                            <td><input title="{LANG_ACTION_URL}" name="tfValue6" type="text" id="tfValue6"
                        ...
                        <tr {RESTRICT_GROUP_ADMIN}>
                            ...
                            <td class="content_tbl_row2">
                                <select title="{RESTRICT_GROUP_ADMIN}" name="selAccGr" class="selectborder"
                                        tabindex="6">
                                    <!-- BEGIN acc_group -->
                        ...
                        <tr class="{VERSION_30_VISIBLE}">
                            <td colspan="6" style="padding-bottom:10px">
                                <iframe id="variableframe" frameborder="0"
                                        src="{BASE_PATH}admin/variabledefinitions.php?dataId={DAT_ID}&amp;linktab=tbl_lnkServicetemplateToVariabledefinition"
                        ...
                        <tr>
                            <td colspan="3"><input name="subForm" type="button" id="subForm4" value="{LANG_SAVE}"
                                                   onClick="LockButton();" {DISABLE_SAVE} tabindex="10">&nbsp;<input
                                        name="subAbort" type="button" id="subAbort4" onClick="abort();"
                                        value="{LANG_ABORT}" tabindex="11"><span
                                        class="required_info">* {LANG_REQUIRED}</span></td>
                            <td colspan="3"><span class="redmessage">{WARNING}</span></td>
                        </tr>
                        <tr>
